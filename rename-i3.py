...
##
# Written by Dave Davenport <qball@gmpclient.org>
#
# A small python script that renames desktops based on the windows displayed.
# It prepends the desktop id for keybinding purposes.
##
...
def get_tree():
    p1 = Popen([I3MSG, "-t", "get_workspaces"], stdout=PIPE)
